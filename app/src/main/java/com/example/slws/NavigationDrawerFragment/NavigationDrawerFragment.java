package com.example.slws.NavigationDrawerFragment;
 ...
 * <p>
 * See the <a href="https://www.google.com/design/spec/patterns/navigation-drawer.html#navigation-drawer-specs">
 * <p>
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null)
            ...
            selectItem(mMenu.findItem(mCurrentSelectedId));

        else

            selectItem(mMenu.getItem(0));  // select first item by default
    ...
    private void selectItem(MenuItem menuItem) {
        ...
        MenuItem previousItem = mMenu.findItem(mCurrentSelectedId);
